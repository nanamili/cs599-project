...
<ul style="font-size:12pt;line-height:2.2;list-style-type:none;padding-left:0;">
<li><a href="#一选题背景与设计思想">一、选题背景与设计思想</a>
<ul style="font-size:12pt;line-height:2.2;">
<li><a href="#11-问题定义">1.1 问题定义</a></li>
<li><a href="#12-现有方案不足">1.2 现有方案不足</a></li>
<li><a href="#13-项目价值">1.3 项目价值</a></li>
<li><a href="#14-技术路线">1.4 技术路线</a></li>
</ul></li>
<li><a href="#二specs-规格文档">二、Specs 规格文档</a>
<ul style="font-size:12pt;line-height:2.2;">
<li><a href="#21-product-spec产品规格">2.1 Product Spec</a></li>
<li><a href="#22-architecture-spec架构规格">2.2 Architecture Spec</a></li>
<li><a href="#23-api-spec接口规格">2.3 API Spec</a></li>
</ul></li>
<li><a href="#三系统架构与设计">三、系统架构与设计</a>
<ul style="font-size:12pt;line-height:2.2;">
<li><a href="#31-整体架构图">3.1 整体架构图</a></li>
<li><a href="#32-langgraph-状态图agent-内部编排">3.2 LangGraph 状态图</a></li>
<li><a href="#33-agent-交互时序以排期场景为例">3.3 Agent 交互时序</a></li>
<li><a href="#34-rag-数据流设计">3.4 RAG 数据流设计</a></li>
<li><a href="#35-各组件细化图">3.5 各组件细化图</a></li>
<li><a href="#36-工程规范">3.6 工程规范</a></li>
</ul></li>
<li><a href="#四关键实现与代码展示">四、关键实现与代码展示</a>
<ul style="font-size:12pt;line-height:2.2;">
<li><a href="#41-agent-核心架构langgraph-主图516行">4.1 Agent 核心架构</a></li>
<li><a href="#42-子-agent-独立-react-循环">4.2 子 Agent ReAct 循环</a></li>
<li><a href="#43-工具定义function-calling">4.3 工具定义</a></li>
<li><a href="#44-sdd-规格配置">4.4 SDD 规格配置</a></li>
<li><a href="#45-mcp-集成--防死循环">4.5 MCP 集成</a></li>
<li><a href="#46-sdd-规格加载器">4.6 SDD 加载器</a></li>
<li><a href="#47-ide-使用截图">4.7 IDE 截图</a></li>
</ul></li>
<li><a href="#五测试与评估">五、测试与评估</a>
<ul style="font-size:12pt;line-height:2.2;">
<li><a href="#51-功能测试">5.1 功能测试</a></li>
<li><a href="#52-自动化-benchmark-评估">5.2 Benchmark 评估</a></li>
<li><a href="#53-demo-截图">5.3 Demo 截图</a></li>
</ul></li>
<li><a href="#六系统升级与扩展">六、系统升级与扩展</a>
<ul style="font-size:12pt;line-height:2.2;">
<li><a href="#61-可扩展架构设计">6.1 可扩展架构</a></li>
<li><a href="#62-技术路线图">6.2 技术路线图</a></li>
<li><a href="#63-各阶段详细规划">6.3 详细规划</a></li>
<li><a href="#64-技术前瞻">6.4 技术前瞻</a></li>
</ul></li>
<li><a href="#七课程总结">七、课程总结</a>
<ul style="font-size:12pt;line-height:2.2;">
<li><a href="#71-个人收获">7.1 个人收获</a></li>
<li><a href="#72-工程思维转变">7.2 工程思维转变</a></li>
<li><a href="#73-对课程的建议">7.3 对课程的建议</a></li>
</ul></li>
</ul>

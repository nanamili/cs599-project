...
<tr><td style="border:2px dashed #999;padding:10pt 20pt;font-size:15pt;text-align:center;white-space:nowrap;"><b>学号</b></td><td style="border:2px dashed #999;padding:10pt 20pt;font-size:15pt;text-align:center;white-space:nowrap;">（填写你的学号）</td></tr>
<tr><td style="border:2px dashed #999;padding:10pt 20pt;font-size:15pt;text-align:center;white-space:nowrap;"><b>姓名</b></td><td style="border:2px dashed #999;padding:10pt 20pt;font-size:15pt;text-align:center;white-space:nowrap;">（填写你的姓名）</td></tr>
...
- [四、关键实现与代码展示](#四关键实现与代码展示)
  ...
  - [4.6 MCP 集成 + 防死循环](#46-mcp-集成--防死循环)
  - [4.7 SDD 规格加载器](#47-sdd-规格加载器)
  - [4.8 IDE 使用截图](#48-vs-code--claude-code-ide-使用截图)
- [五、测试与评估](#五测试与评估)
  - [5.1 功能测试](#51-功能测试)
